...
const settingsSchema = new mongoose.Schema(
  {
    ...
    courier: {
      ...
      runCourierShipperName: { type: String, default: "" },
      runCourierShipperPhone: { type: String, default: "" },
      runCourierShipperAddress: { type: String, default: "" },
      runCourierPickupCode: { type: String, default: "" },
      runCourierDefaultWeight: { type: Number, default: 0.5 },
      runCourierShipperRemarks: {
        type: String,
        default: "Call customer before delivery. Do not leave parcel unattended.",
      },
      runCourierPrintItemDetails: { type: Boolean, default: false },
      runCourierPrintItemDetailsSku: { type: Boolean, default: false },
      runCourierAutoCreateShipment: { type: Boolean, default: false },
      runCourierAutoSaveTracking: { type: Boolean, default: true },
      runCourierAutoCalculateWeight: { type: Boolean, default: false },
      runCourierAutoCalculatePieces: { type: Boolean, default: false },
      runCourierPaidOrdersCodZero: { type: Boolean, default: false },
      runCourierAddOrderNotesInRemarks: { type: Boolean, default: false },
      runCourierCreatePath: { type: String, default: "" },
      runCourierTrackPath: { type: String, default: "" },
      runCourierLabelPath: { type: String, default: "" },
      runCourierCancelPath: { type: String, default: "" },
      runCourierCitiesPath: { type: String, default: "" },
      runCourierCarriersPath: { type: String, default: "" },
      runCourierTestPath: { type: String, default: "" },
      runCourierTestTrackingNumber: { type: String, default: "" },
    },
    notifications: {
      emailOnNewOrder: { type: Boolean, default: true },
      emailOnPaymentReceived: { type: Boolean, default: true },
      emailOnTrackingAdded: { type: Boolean, default: true },
      emailOnDelivered: { type: Boolean, default: true },
      emailOnCancelled: { type: Boolean, default: true },
      emailOnStatusUpdate: { type: Boolean, default: false },
      emailOnCustomerWelcome: { type: Boolean, default: true },
    ...
    emailTemplates: {
      ...
      orderPaymentReceived: { subject: { type: String, default: "" }, body: { type: String, default: "" } },
      orderShipped: { subject: { type: String, default: "" }, body: { type: String, default: "" } },
      orderDelivered: { subject: { type: String, default: "" }, body: { type: String, default: "" } },
      orderCancelled: { subject: { type: String, default: "" }, body: { type: String, default: "" } },
      orderStatusUpdate: { subject: { type: String, default: "" }, body: { type: String, default: "" } },
      customerWelcome: { subject: { type: String, default: "" }, body: { type: String, default: "" } },
