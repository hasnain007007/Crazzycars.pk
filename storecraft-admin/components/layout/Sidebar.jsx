...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/social", label: "Social Posts", icon: "image" },
    ],
  },
  {
    label: "STORE",
...
function Icon({ name }) {
  ...
  const svgProps = { className: common, fill: "none", viewBox: "0 0 24 24", width: 20, height: 20, "aria-hidden": true };
  switch (name) {
    case "home":
      return (
        <svg {...svgProps} strokeWidth={1.5} stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
        </svg>
      );
    case "folder":
      return (
        <svg className={common} width={20} height={20} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    case "playCircle":
      return (
        <svg className={common} width={20} height={20} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden>
      ...
      <div className="flex h-14 shrink-0 items-center gap-2 border-b border-[#e5e7eb] px-4 dark:border-slate-800">
        {settingsLoading && !storeSettings ? (
          ...
          <img
            ...
            width={36}
            height={36}
            className="h-9 w-auto max-w-[36px] rounded object-contain"
