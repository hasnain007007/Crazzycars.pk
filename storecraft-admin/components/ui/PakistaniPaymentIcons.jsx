/** Official-style Pakistani payment logos (admin settings + previews). */
...
export function IconJazzCash({ height = 40 }) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
    <img
      src="/payment-logos/jazzcash.jpg"
      alt="JazzCash"
      width={height}
      height={height}
      style={{
...
export function IconHbl({ height = 40 }) {
  return (
    <LogoBox height={height} viewBox="0 0 36 36" title="HBL">
      ...
      <text x="18" y="30" textAnchor="middle" fill="#FFFFFF" fontFamily="Arial Black, Arial, sans-serif" fontWeight="900" fontSize="8" letterSpacing="1">
        HBL
      </text>
    </LogoBox>
  );
...
export function IconUbl({ height = 40 }) {
  return (
    <LogoBox height={height} viewBox="0 0 36 36" title="UBL">
      ...
      <path d="M18 7l2.5 5.8 6.2.5-4.7 4 1.3 6L18 20.2 12.7 23.3l1.3-6-4.7-4 6.2-.5L18 7z" fill="#FFFFFF" />
      <text x="18" y="31" textAnchor="middle" fill="#FFFFFF" fontFamily="Arial Black, Arial, sans-serif" fontWeight="900" fontSize="7" letterSpacing="0.5">
        UBL
      </text>
    </LogoBox>
  );
