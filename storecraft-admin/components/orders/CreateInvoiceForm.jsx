/**
 * Admin invoice / walk-in sale creator.
 * Auto-loads catalog products so staff can pick items without searching first.
 */
"use client";
...
export function CreateInvoiceForm() {
  ...
  async function submit(e) {
    ...
    try {
      ...
      toast.success(`Invoice ${json.order.orderNumber} created`);
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Pick products from your catalog — all active items load automatically.
          </p>
        </div>
        <Link
          href="/orders"
            ...
            <div className="flex items-center justify-between gap-2">
              <div>
                ...
                <p className="text-xs text-slate-400">
                  {catalogLoading ? "Loading…" : `${catalogTotal} active product${catalogTotal === 1 ? "" : "s"}`}
                </p>
              </div>
              <button
                type="button"
        ...
        <div className="space-y-5 lg:col-span-7">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
            ...
            <p className="mt-2 text-center text-[11px] text-slate-400">
              Opens the order page — use Print Invoice / Send Invoice there.
            </p>
          </div>
        </div>
      </div>
