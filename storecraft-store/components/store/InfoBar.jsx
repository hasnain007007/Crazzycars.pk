  ...
  return (
    <>
      <div className="infobar-desktop">
        <div className="infobar-root" style={{
          background: '#FFFFFF',
          ...
          <ul className="infobar-link-list" style={{
            listStyle: 'none',
            margin: 0,
            padding: 0
          }}>
            {pages.map((page, i) => {
              ...
              return (
                <li key={String(page._id)} style={{
                  borderBottom: i < pages.length - 1
                    ? '1px solid #F0F0F0'
                    : 'none'
                }}>
                  <Link
                    ...
                    className={
                      isActive
                        ? 'infobar-item infobar-item-active'
                        : 'infobar-item'
                    }>
                    <span style={{
                      marginRight: 8,
                      color: isActive ? '#D72323' : '#CCCCCC',
                      fontSize: 10
                    }}>
                      {isActive ? '▶' : '›'}
                    </span>
